...
private val EN = mapOf<String, String>(
    ...
    "Adicionada" to "Added",
    "Adicione fontes da comunidade com um toque" to "Add community sources with one tap",
    "%d jogos" to "%d games",
    "%d instalações" to "%d installs",
    "Buscar fonte..." to "Search source...",
    "Explorar loja de fontes" to "Browse source store",
    "Fonte adicionada" to "Source added",
    "Loja de fontes" to "Source store",
    "Link da loja" to "Store link",
    "Cole o endereço do catálogo de fontes" to "Paste the source catalog address",
    "URL da loja (.json)" to "Store URL (.json)",
    "Carregar loja" to "Load store",
    "Trocar loja" to "Change store",
    "Cole o link da loja pra carregar as fontes." to "Paste the store link to load the sources.",
    "Não consegui sincronizar a loja de fontes." to "Couldn't sync the source store.",
    ...
    "Hydroid 0.9.99 · fork de estudo do Hydra (MIT)" to "Hydroid 0.9.99 · study fork of Hydra (MIT)",
    "Idioma" to "Language",
